...
public abstract class Obstacle {
	...
	/** The current side of the level (out of four) that this body is on */
	...
	/// Storing data for easier access
	/** The current side that this object is on */
	private int side;
	private int[] sideIndices = null;
	...
	/** A cache value for when the user wants to access the force of gravity */
	protected Vector2 gravityCache = new Vector2();
	...
	/**
	 * Returns the current side (of the four in a level) that this physics body
	 * is currently on.
	 *
	 * @return the side that this body is currently on
	 */
	...
	/**
	 * Returns the x-coordinate for this physics body relative to its current side.
	 *
	 * @return the x-coordinate of this physics body in its current side
	 */
	public float getAdjustedX() { return relativePosition.x; }

	public float getAdjustedY() {
		return relativePosition.y;
	}

	public Vector2 getAdjustedPos() {
	...
	public void setRelativePosition(Vector2 relPos) {
		relativePosition.set(relPos);
	}
	 ...
	 * This method does not keep a reference to the parameter.
	 *
	 * @param vx  the linear velocity for this physics body along the x-axis
	 * @param vy  the linear velocity for this physics body along the y-axis
	 */
	public void setLinearVelocity(float vx, float vy) {
		bodyinfo.linearVelocity.set(vx, vy);
	}
	...
	public void setSideOrientation(int orientation) {
		this.sideOrientation = orientation;
	}
	...
	public void setSideIndices(int[] indices) {
		sideIndices = indices;
	}

	public int[] getSideIndices() {
		if (sideIndices == null) {
			sideIndices = new int[3];
		}
		return sideIndices;
	}

	public Vector2 getGravity() {
		return gravityCache.set(gravity);
	}
